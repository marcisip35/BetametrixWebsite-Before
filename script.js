const topHeader = document.querySelector("#topHeader .wrapper");
const bottomHeader = document.querySelector("#bottomHeader .wrapper");

topHeader.innerHTML = `                        <div class="left">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" viewBox="0 0 15 15" version="1.1" fill="#000000">
